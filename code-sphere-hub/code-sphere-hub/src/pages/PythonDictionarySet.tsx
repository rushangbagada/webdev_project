      ...
      <div className="pt-28 pb-12 px-4 max-w-5xl mx-auto">
        ...
        <div className="mb-12">
          <div className={`rounded-xl overflow-hidden shadow-lg ${
            ...
            <iframe 
              ...
              src="https://www.youtube.com/embed/078tYSD7K8E?list=PL0--sAWljl5LEzNyN5Z4zlorThiIUYEV_" 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          >
            ...
            <a 
              href="https://youtu.be/078tYSD7K8E?list=PL0--sAWljl5LEzNyN5Z4zlorThiIUYEV_" 
              target="_blank" 
...
export default PythonDictionarySet;
